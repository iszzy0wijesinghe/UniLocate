...
- Name: dashboard.spec.ts >> Dashboard >> should display live alerts section
- Location: dashboard.spec.ts:39:7
...
Call log:
  ...
  - waiting for getByText('Live Alerts')
