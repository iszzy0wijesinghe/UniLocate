...
- Name: dashboard.spec.ts >> Dashboard >> should show loading state initially
- Location: dashboard.spec.ts:46:7
...
Locator: locator('.MuiCircularProgress-root')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for locator('.MuiCircularProgress-root')
