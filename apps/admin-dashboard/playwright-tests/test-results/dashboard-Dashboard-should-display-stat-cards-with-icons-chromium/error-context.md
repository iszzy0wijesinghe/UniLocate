...
- Name: dashboard.spec.ts >> Dashboard >> should display stat cards with icons
- Location: dashboard.spec.ts:52:7
...
Locator: locator('text=Total Buildings')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Total Buildings')
