...
- Name: dashboard.spec.ts >> Dashboard >> should display operational snapshot section
- Location: dashboard.spec.ts:32:7
...
Locator: getByText('Operational Snapshot')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Operational Snapshot')
