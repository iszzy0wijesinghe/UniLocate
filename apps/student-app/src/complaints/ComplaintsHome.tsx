...
export default function ComplaintsHome({
    ...
    () => [
      {
        label: "All",
        value: "all" as const,
        helper: `${complaints.length} reports`,
      },
      ...complaintCategories.map((category) => ({
        label: category.label,
        value: category.value,
        helper: `${
          complaints.filter((item) => item.category === category.value).length
        } cases`,
      })),
    ],
    [complaints],
  ...
  const awaitingReplyCount = complaints.filter(
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <>
            ...
            <View style={styles.heroCard}>
              ...
              <Text style={styles.heroTitle}>Report privately with UniLocate</Text>
              <Text style={styles.heroSubtitle}>
                Report harm privately and continue follow-up without exposing
                your identity. This device stores only your anonymous complaint
                sessions, so keep your secret somewhere safe in case you need to
                reconnect later.
              </Text>
            ...
            <View style={styles.noticeCard}>
              ...
              <Text style={styles.noticeText}>
                Critical complaints mentioning self-harm, suicide, or violence
                are highlighted for urgent counselor review and emergency
                resource guidance.
              </Text>
            </View>
            ...
            <View style={[styles.sectionHeader, styles.complaintsHeader]}>
              <Text style={styles.sectionTitle}>
                Your stored complaint sessions
              </Text>
              <Text style={styles.sectionMeta}>
                {filteredComplaints.length} visible
              </Text>
            </View>
          </>
        }
        ...
        renderItem={({ item }) => (
          <ComplaintCard
            complaint={item}
            onPress={() =>
              navigation.navigate("ComplaintDetails", { caseId: item.id })
            }
          />
        )}
      />
